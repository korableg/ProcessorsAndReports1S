...
Процедура ВыполнитьОбработкуКоманда(Команда)
	...
	ОтветНаВопрос = Вопрос(НСтр("ru = 'Операцию удаления записей отменить невозможно. Продолжить действие?'"), РежимДиалогаВопрос.ДаНет);
...
мТипыОбрабатываемыхОбъектов = "РегистрСведений";